...
def save_model(config, epoch, model, optimizer, loss_scaler, checkpoint_paths, checkpoint_file_name=None):
...
def save_model_merge_conf(config, epoch, model, optimizer, loss_scaler, checkpoint_paths, config_merge=None, checkpoint_file_name=None):
    os.makedirs(checkpoint_paths, exist_ok=True)
    to_save = {
        'model': model.state_dict(),
        'optimizer': optimizer.state_dict(),
